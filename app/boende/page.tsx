...
export default async function Boende() {
  ...
  return (
    <>
      ...
      <section className="section section--tight" style={{ paddingBottom: 40 }}>
        <div className="container">
          ...
          <p style={{ marginBottom: 0 }}>Flyglarna rymmer sexton bäddar i åtta rum. Två av flyglarna bokas hela för ett sällskap, och fyra av rummen bokas var för sig. Frukostkorgen med lokala råvaror bokas till för 95 kr per person och natt. Hundar är välkomna i alla rum, utan tillägg, och enstaka nätter går alltid att boka.</p>
        </div>
      </section>
      ...
      <section className="section section--tight">
        <div className="container split" style={{ alignItems: "start" }}>
          <div className="prose">
            ...
            <p style={{ marginBottom: 0 }}>Bokningen blir preliminär direkt och bindande när ni fått vår bekräftelse, som kommer inom en vardag. Frukostkorgen levereras till boendet på morgonen så att ni kan börja dagen i lugn och ro.</p>
          </div>
          <ul className="ticks">
