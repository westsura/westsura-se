      ...
      <section className="section--after-head">
        <div className="container split split--start">
          <div className="prose">
            ...
            <p className="contact-lead"><a href={site.phoneHref}>{site.phone}</a><br /><a href={`mailto:${site.email}`}>{site.email}</a></p>
          ...
          <div className="stack stack--lg">
            ...
            <div className="card">
              <h3>Bokningar</h3>
              <p className="small">Boende bokas direkt på sajten. Fest, bröllop, konferens och jakt börjar med en förfrågan eller ett samtal.</p>
              <p className="small mb-0"><strong>{site.company}</strong><br />Org.nr {site.orgNr}</p>
            </div>
          </div>
        </div>
      </section>
